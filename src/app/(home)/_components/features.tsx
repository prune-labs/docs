...
export default function Features() {
  return (
    <Section className="flex-col gap-10 max-w-4xl mx-auto py-16 sm:py-24">
      <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-center sm:text-left">
        Key Features
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
        <div className="flex flex-col gap-3">
          <h3 className="font-semibold text-xl">Runs Anywhere</h3>
          <p className="text-muted-foreground leading-relaxed text-sm sm:text-base text-justify sm:text-left">
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-muted-foreground leading-relaxed text-sm sm:text-base text-justify sm:text-left">
            ...
            to see findings as they are discovered.
          </p>
        </div>
        <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-muted-foreground leading-relaxed text-sm sm:text-base text-justify sm:text-left">
            Resolves TypeScript path aliases like{" "}
            <code className="bg-muted px-1.5 py-0.5 rounded border-border text-[10px] sm:text-xs">
              @/
            </code>{" "}
            and{" "}
            <code className="bg-muted px-1.5 py-0.5 rounded border border-border text-[10px] sm:text-xs">
